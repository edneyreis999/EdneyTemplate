package br.com.edney.project.alfa.TemplateGraphQL.config;
...
import br.com.edney.project.alfa.TemplateGraphQL.repository.PrivilegeRepository;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent>{
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        // == create initial user
        createUserIfNotFound("edneyreis999@gmail.com", "Edney", "123456", new ArrayList<Role>(Arrays.asList(adminRole, userRole)));
        createUserIfNotFound("admin@admin", "Admin", "admin", new ArrayList<Role>(Arrays.asList(adminRole)));
        createUserIfNotFound("user@user", "User", "user", new ArrayList<Role>(Arrays.asList(userRole)));
